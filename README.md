...
This repository contains the source code for a personal website project. It includes a basic Go HTTP server, frontend templates, static assets, and scripts used to include new projects, the sites index is compiled statically using node.

## Overview

- `main.go` launches a simple Go server.
- `http_server/` contains the request handler and server startup logic.
